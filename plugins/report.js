...
let handler = async(m, { conn, text }) => {
    ...
    conn.sendMessage('595983186566@s.whatsapp.net', teks1, MessageType.text)
    //conn.sendMessage('524531106422@s.whatsapp.net', teks1, MessageType.text) // añade tu número aqui, pero no quites el otro. Quita las // del inicio de esta línea
